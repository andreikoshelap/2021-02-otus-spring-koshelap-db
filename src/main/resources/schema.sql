...
CREATE TABLE GENRE(ID BIGINT PRIMARY KEY, GENRE_NAME VARCHAR(50) NOT NULL, GENRE_KEY VARCHAR2(1) NOT NULL);
...
CREATE SEQUENCE HIBERNATE_SEQUENCE START WITH 100 INCREMENT BY 100;