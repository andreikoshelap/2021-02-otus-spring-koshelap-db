...
import ru.otus.spring.event.BookEventPublisher;
import ru.otus.spring.event.EventsPublisher;
...
public class ApplicationEventsCommands {
    ...
    @ShellMethod(value = "Show available books", key = {"b", "books"})
    @ShellMethodAvailability(value = "isPublishEventCommandAvailable")
    public String publishBooks(@ShellOption(defaultValue = "c") String genreKey) {
